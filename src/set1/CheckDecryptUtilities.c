...
const float ascii_frequencies_sorted[] = {0.2254, 0.1126, 0.0807, 0.0727, 0.0665, 0.0621, 0.0594, 0.0559, 0.0541, 0.0532, 0.0381, 0.0355, 0.0248, 0.0248, 0.0213, 0.0213, 0.0195, 0.0177, 0.0177, 0.0169, 0.0133, 0.0087, 0.0068, 0.0013, 0.0013, 0.0008, 0.0007};
//This is the above array but sorted from largest to smallest
